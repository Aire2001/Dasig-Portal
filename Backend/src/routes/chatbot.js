...
// Follow-up suggestions per intent — never repeat the question just answered
const FOLLOWUPS = {
  ...
  member_institutions:  ['How do I apply for membership?', 'What are the membership tiers?', 'Tell me about DASIG partnerships'],
  ...
  training:             ['What levels of training are available?', 'Will I get a certificate?', 'What are the membership fees?'],
  membership:           ['What are the two membership tiers?', 'How much does membership cost?', 'What is my membership status?'],
  membership_status:    ['How do I renew my membership?', 'What are member benefits?', 'How do I update my profile?'],
  membership_renewal:   ['How much does membership cost?', 'How do I contact admin?', 'What are the two membership tiers?'],
  news:                 ['How do I read members only articles?', 'What events are upcoming?', 'What funding is available?'],
  policy:               ['How do I access governance documents?', 'What are member-only policies?', 'How do I contact admin?'],
  funding:              ['What is the DOST SEI scholarship?', 'What is the application deadline?', 'How do I become a member?'],
  partnerships:         ['Tell me about the CHED partnership', 'What research collaborations exist?', 'How do I become a member?'],
  login:                ['How do I create a new account?', 'How do I reset my password?', 'What can guests access?'],
  register_account:     ['How do I become a member?', 'What are the two membership tiers?', 'What can guests do?'],
  contact:              ['How do I report a technical issue?', 'How do I apply for membership?', 'What events are upcoming?'],
  roles:                ['How do I become a member?', 'What can guests access?', 'What can admins do?'],
  tiers:                ['How do I apply for membership?', 'How much does membership cost?', 'What are member benefits?'],
  fees:                 ['How do I apply for membership?', 'What is the DOST SEI scholarship?', 'What is my membership status?'],
  research:             ['Tell me about DASIG partnerships', 'What funding opportunities exist?', 'What events are upcoming?'],
  summit:               ['How do I register for an event?', 'What events are upcoming?', 'How do I become a member?'],
  ...
  chatbot_capabilities: ['What events are upcoming?', 'How do I become a member?', 'What funding is available?'],
  attendance:           ['What events are upcoming?', 'How do I register for an event?', 'How do I check my registrations?'],
  certificate:          ['What levels of training are available?', 'Who issues the certificate?', 'What are the membership fees?'],
  event_capacity:       ['What events are upcoming?', 'How do I register for an event?', 'What training is available?'],
  data_privacy:         ['How do I access governance documents?', 'How do I contact admin?', 'How do I update my profile?'],
  ched:                 ['Tell me about DASIG partnerships', 'What funding opportunities exist?', 'Who are the consortium members?'],
  consortium_history:   ['Who are the consortium members?', 'What is in the DASIG portal?', 'How do I join DASIG?'],
  region_7:             ['Who are the consortium members?', 'What events are upcoming?', 'Tell me about DASIG partnerships'],
  admin_panel:          ['How do I become a member?', 'What are the two membership tiers?', 'What can admins do?'],
  it332:                ['What is in the DASIG portal?', 'What can Haribon help with?', 'What events are upcoming?'],
  logout:               ['How do I log in?', 'What can guests do?', 'How do I become a member?'],
  ...
  my_trainings:         ['What training is available?', 'What levels of training are available?', 'Will I get a certificate?'],
  ...
  news_members_only:    ['How do I become a member?', 'What are the latest announcements?', 'What events are upcoming?'],
