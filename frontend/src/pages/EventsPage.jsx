      ...
      {formModal && (
        <div onClick={() => !submitting && setFormModal(null)} style={{
          ...
          <div onClick={e => e.stopPropagation()} style={{
            ...
            {/* banner */}
            <div style={{ background: gradient(formModal), padding:'22px 24px 18px', position:'relative', overflow:'hidden', borderRadius:'22px 22px 0 0' }}>
      ...
      {okModal && (
        <div onClick={() => setOkModal(null)} style={{
          ...
          <div onClick={e => e.stopPropagation()} style={{
            ...
            {/* Header */}
            <div style={{ background: gradient(okModal.event), padding:'36px 32px 60px', textAlign:'center', position:'relative', flexShrink:0, overflow:'hidden', borderRadius:'24px 24px 0 0' }}>
              {/* ✕ Close button */}
