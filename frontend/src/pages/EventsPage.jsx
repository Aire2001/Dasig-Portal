      ...
      {okModal && (
        <div onClick={() => setOkModal(null)} style={{
          ...
          <div onClick={e => e.stopPropagation()} style={{
            ...
            <div style={{ background: gradient(okModal.event), padding:'28px 24px 50px', textAlign:'center', position:'relative' }}>
              <div style={{ color:'#fff', fontSize:20, fontWeight:900 }}>Registration Confirmed! 🎉</div>
              <div style={{ color:'rgba(255,255,255,0.75)', fontSize:12.5, marginTop:4 }}>{okModal.event.title}</div>
              <div style={{
            ...
            <div style={{ paddingTop:46, paddingLeft:24, paddingRight:24, textAlign:'center' }}>
              ...
              <span style={{
                ...
                background: okModal.role === 'ADMIN' ? '#fef9c3' : okModal.role === 'MEMBER' ? '#dcfce7' : '#eff6ff',
                color: okModal.role === 'ADMIN' ? '#713f12' : okModal.role === 'MEMBER' ? '#14532d' : '#1e40af',
                borderRadius:20, padding:'3px 12px', fontSize:11, fontWeight:700,
              }}>{okModal.role || 'GUEST'}</span>
            </div>
            ...
            <div style={{ padding:'12px 24px 24px', display:'flex', flexDirection:'column', gap:8 }}>
              {[
                ...
                <div key={r.label} style={{
                  ...
                  background:'rgba(255,255,255,0.06)', borderRadius:10, padding:'9px 14px',
