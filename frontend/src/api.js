...
export const api = {
  ...
  events: {
    ...
    register: (id, body) => request(`/events/${id}/register`, { method: 'POST', body: body ? JSON.stringify(body) : undefined }),
  ...
  training: {
    ...
    enroll: (id, body) => request(`/training/${id}/enroll`, { method: 'POST', body: body ? JSON.stringify(body) : undefined }),
